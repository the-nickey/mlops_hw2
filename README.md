...
"Продвинутый" ML выиграл - лучшие результаты дали XGBoost (R^2 = 0,83) и randomforest (R^2 = 0,78); там же более плотным выглядит распределение ошибок. Можно было бы ещё заморочиться, но в целом этих метрик для выводов достаточно.
